...
export default function CaseStudies() {
    const { t } = useLanguage();
    const { heading, items } = t.caseStudies;
    ...
    return (
        <section id='casestudies' className="min-h-fit w-full flex relative bg-black text-white overflow-hidden ">
                ...
                >
                    <div className="flex-1 flex flex-col justify-center text-center md:text-left ">
                        ...
                        <div className="mt-6 grid grid-col-1 lg:grid-cols-3 sm:grid-cols-1 gap-3 lg:gap-20 max-w-auto mx-[2vw] ">
                            ...
                            {items.map((item, i) => (
                                <motion.div key={i} className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-center min-w-[350px] flex flex-col justify-between"
                                ...
                                >
                                    ...
                                    <div className="pt-4 text-justify px-5 text-md text-gray-400">
                                        <li>
                                            {item.value3.startsWith('/') ? (
                                                <Link
                                                    to={item.value3}
